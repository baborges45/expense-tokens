...
class AliasMixin implements AliasMixinBase {
  ...
  @override
  Border get focus => Border.all(width: aliasTokens.defaultt.borderWidth, color: globalTokens.colors.purple300);

  @override
  Color get pressedOutline => globalTokens.colors.grey500.withValues(alpha: globalTokens.shapes.opacity.low);

  @override
  Color get onPressedOutline => globalTokens.colors.grey50.withValues(alpha: globalTokens.shapes.opacity.superLow);

  @override
  Color get pressedOutlineInverse => globalTokens.colors.grey300.withValues(alpha: globalTokens.shapes.opacity.superLow);

  @override
  Color get overlayDefault => globalTokens.colors.grey900.withValues(alpha: globalTokens.shapes.opacity.high);
