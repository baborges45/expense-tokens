...
class AliasColorSelected implements AliasColorSelectedBase {
  ...
  @override
  Color get bgColor => globalTokens.colors.grey0;
  ...
  @override
  Color get onBgColor => globalTokens.colors.grey700;

  @override
  Color get onLabelColor => globalTokens.colors.grey700;

  @override
  Color get onIconColor => globalTokens.colors.grey700;
}
