...
class AliasColorAction implements AliasColorActionBase {
  ...
  @override
  Color get bgPrimaryColor => globalTokens.colors.grey0;

  @override
  Color get borderPrimaryColor => globalTokens.colors.grey0;

  @override
  Color get labelPrimaryColor => globalTokens.colors.grey0;

  @override
  Color get iconPrimaryColor => globalTokens.colors.grey0;

  @override
  Color get onLabelPrimaryColor => globalTokens.colors.grey700;

  @override
  Color get onIconPrimaryColor => globalTokens.colors.grey700;
  ...
  @override
  Color get onLabelSecondaryColor => globalTokens.colors.grey700;

  @override
  Color get onIconSecondaryColor => globalTokens.colors.grey700;
}
